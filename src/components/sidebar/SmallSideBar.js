...
const SmallSideBar = inject("store")(
  observer(
    class SmallSideBar extends React.Component {
      loadSprints = () => {
        this.props.store.projectStore.getProject(
          this.props.store.projectStore.projectId
        );
      };
          ...
          <div className="smallSideBar">
            ...
            {this.props.store.projectStore.projectId !== undefined && (
              <div
                onClick={() => {
                  console.log(
                    "ik ben kankergrappig want ik vind kanker grappig"
                  );
