...
const WorkItemWindow = inject("store")(
  observer(
    class WorkItemWindow extends Component {
      ...
      getWorkItem = workItemId => {
        return this.props.store.projectStore.workItems.find(
      ...
      sendWorkItemUpdate = () => {
        this.props.store.projectStore.updateWorkItem(
          this.state.workItem.workItemId,
          this.state.workItem
        );
      };
      ...
      render() {
        ...
        return (
          <div
            className="backdrop"
            onClick={this.props.store.clientStore.closeWorkItem}
          >
            <div className="window" onClick={event => event.stopPropagation()}>
              <div className="windowHeader">
                <div className="headerNameTab">
                  ...
                  <EditableTitle
                    placeholder="Task"
                    title={this.state.workItem.workItemTitle}
                    titleChanged={title =>
                      this.updateWorkItem({ workItemTitle: title })
                    }
                  ...
                  <div className="top">
                    ...
                    <div className="workItemOptions">
                      ...
                      <WorkItemOption
                        ...
                        type="TextSelection"
                        default="undefined"
                        value={this.state.workItem.workItemUser}
                        onValueChanged={value =>
                          this.updateWorkItem({ workItemUser: value })
                        }
                      />
                      <WorkItemOption
                        title="Sprint"
                        type="ListSelection"
                        default="undefined"
                        value={this.state.workItem.Lane.Sprint.id}
                        options={Array.from(
                          this.props.store.projectStore.sprints,
                          x => (x = { id: x.sprintId, title: x.sprintTitle })
                        )}
                        onValueChanged={value =>
                          this.updateWorkItem({
                            Lane: { Sprint: { id: value } }
                          })
                        }
                      />
                      <WorkItemOption
                        ...
                        default="0"
                        value={this.state.workItem.workItemTimeEst}
                        onValueChanged={value =>
                          this.updateWorkItem({ workItemTimeEst: value })
                        }
                      />
                      <WorkItemOption
                        title="Tag"
                        type="TextSelection"
                        default="undefined"
                        value={this.state.workItem.workItemStatus}
                        placeholder="Enter tag"
                        onValueChanged={value =>
                          this.updateWorkItem({ workItemStatus: value })
                        }
                      />
                      <WorkItemOption
                        title="Color"
                        type="ColorSelection"
                        default="dodgerblue"
                        value={this.state.workItem.workItemColor}
                        onValueChanged={value =>
                          this.updateWorkItem({ workItemColor: value })
                        }
                      />
                    </div>
                  </div>
