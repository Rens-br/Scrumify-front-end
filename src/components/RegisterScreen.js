            ...
            <div>
                <Formik
                    ...
                    onSubmit={(values,actions) => {
                        props.store.socketStore.sendRegister({
                            email: values.email,
                            name: values.name,
                            password: values.password
                        });

                        console.log(props.store.userStore.registerMessage);
                        setTimeout(() => {
                            actions.setFieldError('email', props.store.userStore.registerMessage);
                            props.store.userStore.clearRegister();
